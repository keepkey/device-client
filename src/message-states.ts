...
export class MessageStates {
  ...
  private static states: Array<MessageState> = [];

  public static getMessageState(sender: MessageSender, direction: MessageDirection, name: MessageName): MessageState {
  ...
  public static register(state: MessageState) {
